                ...
                <div className='flex p-4'>
                    ...
                    <div className='ml-2 w-full'>
                        <div className='flex items-center'>
                            <h1 className='font-bold'>{tweet?.userDetails[0]?.firstName}{" "}{tweet?.userDetails[0]?.lastName}</h1>
                        ...
                        <div className='flex justify-between my-2'>
                            <div className='flex items-center justify-between'>
                                <div onClick={() => likeHandler(tweet?._id)} className='p-2 hover:bg-pink-200 cursor-pointer rounded-full'>

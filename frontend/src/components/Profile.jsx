...
function Profile() {
    ...
    useGetProfile(id)
    return (
        <div className='w-[55%] border-l border-r border-gray-200'>
            <div className='ml-2'>
                ...
                <div className='ml-4 mt-1 text-sm'>
                    <p>
                        Exploring the web's endless possibility with MERN Stack! Long Rider | Follows Multiple Sports : Endurance racing|Test Cricket|Rally|Formula 1|
                    </p>
                </div>
            </div>
        </div>
